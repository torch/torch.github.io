...
even with the help of the original authors [[2]](#rmva.ref). 
However, the authors of [[1]](#rmva.ref) did a great job on making their paper clear, 
...
Specifically, it uses a the REINFORCE algorithm [[4]](#rmva.ref). 
...
*Unlike backpropagation [[5]](#rmva.ref), this objective doesn't need to be differentiable*.
...
and extended the RAM to multiple-object detection [[6]](#rmva.ref).
...
2. *Alexander A. Aarts, et al.*, Estimating the reproducibility of psychological science, [Science 28 August 2015](http://www.sciencemag.org/content/349/6251/aac4716)
3. *Gregor, Karol, et al.*, DRAW: A recurrent neural network for image generation, [Arxiv 2015](http://arxiv.org/abs/1502.04623)
4. *Williams, Ronald J.*, Simple statistical gradient-following algorithms for connectionist reinforcement learning, [Machine learning 8.3-4 (1992): 229-256](http://link.springer.com/article/10.1007/BF00992696).
5. *Rumelhart, David E., Geoffrey E. Hinton, and Ronald J. Williams.* Learning internal representations by error propagation, [No. ICS-8506](http://oai.dtic.mil/oai/oai?verb=getRecord&metadataPrefix=html&identifier=ADA164453)
6. *Ba, Jimmy, Volodymyr Mnih, and Koray Kavukcuoglu*, Multiple object recognition with visual attention, [Arxiv 2015](http://arxiv.org/abs/1412.7755)
